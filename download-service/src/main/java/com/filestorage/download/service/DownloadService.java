package com.filestorage.download.service;
...
public class DownloadService {
    ...
    public DownloadService(FilesystemClient filesystem, DownloadObjectStorage objectStorage, ZipJobRepository zipJobs,
   ...
   public  DownloadUrlResponse fileUrl(UUID userId, UUID fileId) {
    ...
    @Transactional
    public ZipJobResponse requestZip(UUID userId, UUID folderId) {
   ...
   public  ZipJobResponse getZipJob(UUID jobId) {
   ...
   public  DownloadUrlResponse zipDownloadUrl(UUID jobId) {
