...
@Component
public class DownloadObjectStorage {
   ...
   public  PresignedGet presignGet(String storageKey) {
    return presignGet(storageKey, null, null);
    }

   public  PresignedGet presignGet(String storageKey, String name, String mimeType) {
    ensureBucket();
        try {
   ...
   public  void writeZipEntry(ZipOutputStream zip, ArchiveFileItem item) {
    ensureBucket();
   ...
   public  void putObject(String storageKey, InputStream input, long size, String contentType) {
    ensureBucket();
        try {
