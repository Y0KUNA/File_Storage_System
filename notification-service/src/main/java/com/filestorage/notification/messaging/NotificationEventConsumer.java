package com.filestorage.notification.messaging;
...
public class NotificationEventConsumer {
    ...
    public NotificationEventConsumer(NotificationRepository notifications,
    ...
    public void onEvent(EventEnvelope event) throws Exception {
